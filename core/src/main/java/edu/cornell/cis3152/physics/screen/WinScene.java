...
public class WinScene  implements Screen {
    ...
    private static final String[] LABELS = { "NEXT LEVEL", "QUIT TO MENU" };

    private static final Color OVERLAY = new Color(0.10f, 0.28f, 0.10f, 0.75f);
    private static final Color SELECTED  = new Color(0.85f, 0.65f, 0.05f, 1f);
